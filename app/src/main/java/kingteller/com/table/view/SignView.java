package kingteller.com.table.view;
...
public class SignView extends View {
    ...
    private SignPathListener signPathListener;


    public void setSignPathListener(SignPathListener signPathListener) {
        this.signPathListener = signPathListener;
    }
    ...
    public void clear() {
        if (cacheCanvas != null) {
            isTouched = false;
            mGesturePaint.setColor(BACKGROUND_COLOR);
    ...
    public interface SignPathListener{
        public void refreshDraw(boolean isTouched);
    }
}
