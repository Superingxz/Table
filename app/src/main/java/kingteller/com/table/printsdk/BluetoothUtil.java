...
public class BluetoothUtil {
    ...
    public static final int BLUETOUCH_DISCONNECT = 4;//断开蓝牙
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(PrintConfig.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(PrintConfig.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(PrintConfig.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(PrintConfig.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        // bundle.putString(PrintConfig.TOAST, "Unable to connect device");
        bundle.putString(PrintConfig.TOAST, "无法连接设备");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(PrintConfig.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        //bundle.putString(PrintConfig.TOAST, "Device connection was lost");
        bundle.putString(PrintConfig.TOAST, "蓝牙已断开连接");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    if (mmServerSocket != null) {
                        ...
                        socket = mAdapter.listenUsingRfcommWithServiceRecord(NAME, MY_UUID).accept();
                        setState(BLUETOUCH_DISCONNECT);
                    }
                } catch (IOException e) {
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
	                    ...
	                    mHandler.obtainMessage(PrintConfig.MESSAGE_READ, bytes, -1, buffer)
	                            .sendToTarget();
                    }
                    else
                    {
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                mHandler.obtainMessage(PrintConfig.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
